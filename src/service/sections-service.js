...
export async function getSections(searchParams) {
  try {
    ...
    const sqlText = `
      SELECT s.id, s.class_id, s.module_id, s.section_start_date, s.section_end_date, s.section_fee, s.section_total_fee, s.section_status_dynamic, s.section_delete_disabled,
